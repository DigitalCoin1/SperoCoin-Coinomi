package com.sperocoin.core.coins.nxt;
...
//                + " existing key " + com.sperocoin.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.sperocoin.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.sperocoin.core.coins.nxt.Crypto.rsDecode(com.sperocoin.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.sperocoin.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.sperocoin.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.sperocoin.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.sperocoin.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.sperocoin.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.sperocoin.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
