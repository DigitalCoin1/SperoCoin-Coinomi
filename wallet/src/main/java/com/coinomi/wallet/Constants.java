...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(SperocoinMain.get(),   new ServerAddress("electrum.sperocoin.org", 5001),
                                                    new ServerAddress("electrum1.sperocoin.org", 5001),
                                                    new ServerAddress("electrum.sperocoin.org", 5002),
                                                    new ServerAddress("electrum1.sperocoin.org", 5002)),
